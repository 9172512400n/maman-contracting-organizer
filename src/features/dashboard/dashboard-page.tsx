...
export default function DashboardPage() {
  ...
  return (
    <>
      ...
      <div className="panel-grid">
        <SectionCard title="Tasks" description="Open, done, and closed task records.">
          {loading ? (
        ...
        <SectionCard
          ...
          action={
            session?.isAdmin ? (
              <form className="actions-row" onSubmit={onCreateNotification}>
                <input name="message" placeholder="Message for the team" />
      ...
      <SectionCard title="Activity log" description="Recent records from the legacy `activity` collection.">
        {loading ? (
